...
// 공공 데이터 API 주소 http://apis.data.go.kr/ :뒤쪽_화살표: React 에서 .env 로 port=80 처리를 해준 것
// 내 컴퓨터 주소 http://localhost:포트번호/ :뒤쪽_화살표: React 에서 .env 로 port=80 처리를 해주지 않은 것
